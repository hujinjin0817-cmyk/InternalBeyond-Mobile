...
function offlinePage(){return new Response('<!DOCTYPE html><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Mian</title><body style="margin:0;min-height:100vh;display:flex;align-items:center;justify-content:center;font-family:-apple-system,BlinkMacSystemFont,\'PingFang SC\',sans-serif;background:#f6f2f7;color:#332f45"><div style="text-align:center;padding:24px"><div style="font-size:1.05rem;margin-bottom:10px">Mian 暂时加载不上</div><div style="font-size:0.84rem;color:#6e6787;line-height:1.7">本机还没有离线副本，网络也没回应。<br>检查网络后点下面重试。</div><button onclick="location.reload()" style="margin-top:18px;height:40px;padding:0 22px;border-radius:999px;border:1px solid rgba(193,160,172,.55);background:#fff;color:#806c79;font-size:0.9rem">重试</button></div></body>',{status:200,headers:{'Content-Type':'text/html; charset=utf-8'}})}
